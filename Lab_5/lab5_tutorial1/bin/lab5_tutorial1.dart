...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'chocolate',
    'cake'
  ]; //This is same as , final desserts = const['ice-creame','pastry','laddu'];
  // Below 3 will not work because list is const
  // desserts.add('ice-creame');
  // desserts.remove('laddu');
  // desserts[0] = 'shake';
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'Devansh');
  User user2 = User(2, 'Ram');
  User user3 = User(3, 'Shyam');
